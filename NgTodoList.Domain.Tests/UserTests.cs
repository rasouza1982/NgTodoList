...
namespace NgTodoList.Domain.Tests
{
    ...
    public class Dado_um_novo_usuario
    {
        ...
        {
            var user = new User("Rafael Souza", "", "rasouza");
        }
        ...
        {
            var user = new User("Rafael Souza", "teste", "rasouza");
        }
        ...
        {
            var user = new User("Rafael Souza", "souza.rafael@gmail.com", "rasou");
        }
        ...
        {
            var user = new User("Rafael Souza", "souza.rafael@gmail.com", "rasouza");
    ...
    public class Ao_alterar_senha
    {
        ...
        {
            user.ChangePassword("souza.rafael@gmail.com", "rasouza", "ras", "ras");
        }
        ...
        {
            user.ChangePassword("souza.rafael@gmail.com", "ras", "rasouza2", "rasouza2");
        }
